...
1. Just exploring the data?
   ...
   You can look up images for a sample, distinguishing features, most-similar genes or compounds, and more\! See the [Interactive Tools](./howto/interactive_tools.md) page for instructions for these tools. 
